...
// var btnSubmit = document.querySelector("#intialsSubmit");
...
var q2 = {
  question:
    "#2 Choose the correct JavaScript syntax to change the content of the following HTML code:&nbsp;<code>&lt;p id='msgBox'&gt;Message Placeholder&lt;/p&gt;</code>",
  ans1: '<code>document.getElement(msgBox).innerHTML="Hello World!";</code>',
  ans2:
    '<code>document.getElementById("msgBox").innerHTML="Hello World!";</code>',
...
var q3 = {
  question:
    '#3 Which of the following is the correct syntax to display "Hello World!" in an alert box using JavaScript?',
...
var q5 = {
  question:
    '#5 Predict the output of the following JavaScript code:<br ><code>&lt;script type="text/javascript"&gt;<br />a = 8 + "8";<br />document.write(a); &lt;/script&gt;</code>',
  ans1: "16",
...
function displayScores() {
  ...
  for (i = 0; i < scoreboard.length; i++) {
    ...
    if (
      scoreboard[i].initials === initials &&
